...
*/
/// <summary>
/// Update the BusinessRules class 
/// </summary>
namespace Utility   
{
    /// <summary>
    ...
    public static class BusinessRules
    {
        ...
        {
            /// Evaluate the errorCode and return the corresponding string
            switch (errorCode)
            {
                case -100:
        ...
        /// <summary>
        /// creating a static method in the Utility project to accomplish the Description state. 
        /// </summary>
        /// <param name="typeName"></param>
        /// <returns></returns>
        public static string GetDescription(string typeName)
        {
            string subState = typeName.Replace("State", "");
            int stateIndex = subState.LastIndexOf("State");
            if (stateIndex >= 0)
            {
                return subState.Substring(0, stateIndex);
            }
            return subState;
        }
        /// <summary>
        /// creating a static method in the Utility project to accomplish CourseType. 
        /// </summary>
        public static string GetCourseType(string courseTypeS)
        {
            CourseType type = (CourseType)Enum.Parse(typeof(CourseType),
                courseTypeS.Replace("Course", ""));
            return Enum.GetName(typeof(CourseType), type);
        }

        public static string RemoveCourse(string className, string trailer)
        {
